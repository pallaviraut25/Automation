...
public class BaseClass {
	...
	public static void screenshot(String foldername, String Screenshotname) throws IOException {
		...
		File folder = new File(projectpath + "\\" + foldername);
		...
		File target = new File(folder + "\\" + Screenshotname + ".png");

		FileHandler.copy(source, target);
	}

	public static void takeScreenshot(String Screenshotname1) throws IOException {

		// String projectpath = System.getProperty("user.dir");
		File folder = new File(projectpath + "\\SSListeners");
		...
		File target1 = new File(folder + "\\" + Screenshotname1 + ".png");
